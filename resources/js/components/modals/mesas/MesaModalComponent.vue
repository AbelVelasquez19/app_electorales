                        ...
                        <div class="row mb-1">
                            <div class="col-md-6">
                                <div class="me-1">
                                    <div class="dataTables_filter">
                                        <label>Nombre: </label>
                                        <input type="text" placeholder="nombre mesa" v-model="mesa.nombre" class="form-control" :class="errors != null && errors.nombre ? 'is-invalid' : ''">
                            ...
                            <div class="col-md-6">
                                <div class="me-1">  
                                    <div class="dataTables_filter">
                                        <label>Número: </label>
                                        <input type="number" placeholder="número mesa" v-model="mesa.numero" class="form-control" :class="errors != null && errors.numero ? 'is-invalid' : ''">
                                        <span v-if="errors != null && errors.numero" class="text-danger">{{ errors.nombre[0] }}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <label>Centro de Votación: </label>
                                <select class="form-select" v-model="mesa.centro_votacion_id" :class="errors != null && errors.centro_votacion_id ? 'is-invalid' : ''">
                            ...
                            <div class="col-md-6">
                                <div class="me-1">
                                    <div class="dataTables_filter">
                                        ...
                                        <input type="number" placeholder="número mesa" v-model="mesa.cantidad_votantes" class="form-control" :class="errors != null && errors.cantidad_votantes ? 'is-invalid' : ''">
                                        <span v-if="errors != null && errors.cantidad_votantes" class="text-danger">{{ errors.cantidad_votantes[0] }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
